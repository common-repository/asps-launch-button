...
Plugin URI: https://www.artistscope.com/asps_launch_button.asp
Version: 2.3
Description: Launches the ArtistScope Web Browser from the default browser
Author: ArtistScope
Author URI: https://www.artistscope.com

	Copyright 2017 ArtistScope Pty Limited
...
class Launch_Button extends WP_Widget
{
  ...
  {
    $widget_ops = array('classname' => 'Launch_Button', 'description' => 'Button to launch the ArtistScope Web Browser');
